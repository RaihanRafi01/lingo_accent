...
class PasswordChangedBottomSheet extends StatefulWidget {
  ...
  const PasswordChangedBottomSheet({Key? key, required this.onBackToLogin})
      : super(key: key);

  @override
  _PasswordChangedBottomSheetState createState() =>
      _PasswordChangedBottomSheetState();
}

class _PasswordChangedBottomSheetState
    extends State<PasswordChangedBottomSheet> {
      ...
      child: Column(
        ...
        children: [
          ...
          AnimatedOpacity(
            ...
            child:
                SvgPicture.asset('assets/images/auth/password_change_tic.svg'),
          ),
